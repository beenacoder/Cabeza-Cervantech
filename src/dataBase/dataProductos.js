...
const  listaProductos = [
    {id: '1', title: 'Boligrafo', category: 'escritura', description: 'Boligrafo Bic trazo grueso azul', price: 80, pictureUrl:'https://i.ibb.co/KWyLvSv/bic-Grueso.jpg'},
    {id: '2', title: 'Carpeta 3 Solapas', category: 'oficina', description: 'Carpeta 3 solapas', price: 150, pictureUrl:'https://i.ibb.co/ZMvzMMQ/carpeta3-Solapas.jpg'},
    {id: '3', title: 'Adhesivo Sintético', category: 'pegamentos', description: 'Adhesivo Sintetico', price: 70, pictureUrl:'https://i.ibb.co/1JWzSsR/adhesivo-Pelikan.jpg'},
    ...
    {id: '11', title: 'Porta-mina Pizzini', category: 'escritura', description: 'Portamina Pizzini 0.5 mm', price: 280, pictureUrl:'https://i.ibb.co/026pJTP/portamina-Pizzini.jpg'},
    {id: '12', title: 'Plasticola con brillo', category: 'pegamentos', description: 'Plasticola con brillo marca Plasticola 30ml', price: 60, pictureUrl:'https://i.ibb.co/MMRxJJb/plasticola-Brillo.jpg'},
]
